...
<div class="z-10">
    ...
    <div>
        <a href="{{ route('listing.create') }}"class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl uppercase mt-2 hover:text-black hover:border-black">
            Post a Gig
        </a>
    </div>
</div>
